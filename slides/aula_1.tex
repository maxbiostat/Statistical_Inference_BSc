...
\begin{defn}[\textbf{Média amostral}]
...
\begin{theo}[\textbf{Lei Fraca dos Grandes Números}]
\label{thm:WLLN}
Sejam  $\rs$ variáveis aleatórias independentes e identicamente distribuídas, com média $\mu$ e variância $\sigma^2$.
 Então
...
\begin{defn}[ \textbf{Convergência quase certa}]
...
\begin{theo}[\textbf{Teorema Central do Limite} (Lindeberg e Lévy)\footnote{Jarl Waldemar Lindeberg (1876--1932) e Paul Pierre Lévy (1886--1971).}]
