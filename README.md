...
- Exercícios de revisão para a A1 podem ser encontrados [aqui](https://github.com/maxbiostat/Statistical_Inference_BSc/blob/master/exercicios/exerc%C3%ADcios_revis%C3%A3o_A1.pdf).
